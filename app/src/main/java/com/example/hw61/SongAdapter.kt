...
class SongsAdapter(private val list: List<Song>, private val onItemClick: (title: String) -> Unit) : Adapter<SongsAdapter.SongsViewHolder>() {
    ...
    inner class SongsViewHolder(private val binding: ItemSongBinding) : ViewHolder(binding.root) {
        fun onBind(music: Song) = with(binding) {
